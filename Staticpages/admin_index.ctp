                      ...
                      echo $this->Html->image('../files/staticpage/'.$staticpage['Staticpage']['image']
                        ...
                        <td><?php echo h($staticpage['Staticpage']['created']); ?>&nbsp;</td>
                                <td><?php if ($staticpage['Staticpage']['status'] == '0') { ?>
                                    <?php echo $this->Form->postLink('Inactive', array('action' => 'activate', $staticpage['Staticpage']['id']), array('escape' => false, 'class' => 'archive_12'));
                                    ?></span><?php } else { ?>
                                ...
                                <td class="actions">
                                    ...
                                    if ($staticpage['Staticpage']['status'] == 0) {
                                        echo $this->Form->postLink(('Inactive'), array('Controller' => 'Staticpages', 'action' => 'admin_activate', $staticpage['Staticpage']['id']), array('escape' => false, 'class' => 'active1', 'title' => 'Active'));
                                    } else {
                                        echo $this->Form->postLink(('Active'), array('controller' => 'Staticpages', 'action' => 'admin_deactivate', $staticpage['Staticpage']['id']), array('escape' => false, 'class' => 'deactive1', 'title' => 'Block'));
                                    }
                                    ?>
                                </td>
                            </tr>

        ...
        <div class="smart-container">
            ...
            <div class="col-md-4">                
                    <div class="form-group"> 
                          <?php echo $this->Form->select('position',array('our_vision'=>'Our vision', 'about_us' => 'About Us','t&c'=>'Term & Conditions','faq' => 'Faq', 'slider' => 'Header Slider', 'banner_heading' => 'Banner Heading')

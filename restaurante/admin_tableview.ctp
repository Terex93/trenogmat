        ...
        <table class="authors-list">
            <tr>
                ...
                foreach ($rdata as $cartdatas) {
                    ?>
                    <td><a href="http://trenogmat.no/admin/restaurants/menudetai/<?php echo $cartdatas['Restable']['res_id']; ?>/<?php echo $cartdatas['Restable']['tableno']; ?>"><?php echo $cartdatas['Restable']['tableno']; ?><span class="authors-booked"></span></a></td>
                <?php } ?>
            </tr>
        </table>
    </div>

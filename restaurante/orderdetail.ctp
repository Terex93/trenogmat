...
echo $order_id = $orderids['Order']['id'];
echo $order_date = $orderids['Order']['created'];
echo $order_status = $orderids['Order']['status'];
echo $order_order_type = $orderids['Order']['order_type'];
echo $order_dl_status = $orderids['Order']['dl_status'];
echo $restaurant_name = $orderids['Restaurant']['name'];
echo $restaurant_logo = $orderids['Restaurant']['logo'];
                	...
                	<div class="row ord_row"> 
                        ...
                        <div class="row ord1_row"> 
                            ...
                            <div class="col-md-6 order_det"> 
                            	<a href="#"><img src="/dropin/files/restaurants/r3.jpg" alt="" />
                                <span class="res_nme"> The Altius Hotel </span>
                                <span class="date1">2016-12-02 <!--<br/>12:05:04--></span>
                                </a>
                            </div>
                       ...
                       <span> 
                       <p> Order Type : </p>
                        <a href="#" class="newsletter-cta"> Cash</a>
                       </span> 
                       <span> 
                       <p> Delivery Status : </p>
                          <a href="#" class="newsletter-cta">Dine</a>
                        </span>
                        </div>

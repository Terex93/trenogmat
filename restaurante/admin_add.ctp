...
<?php echo $this->Form->input('logo', array('type' => 'file', 'class' => 'form-control fileContainer', 'label' => 'Logo:')); ?>
...
<?php //echo $this->Form->input('delivery_distance', array('class' => 'form-control', 'label' => 'Delivery Distance in miles:')); ?>
                    ...
                    <div class="form-group">
                    <?php echo $this->Form->input('delivery_fee', array('class' => 'form-control col-sm-2', 'label' => 'Delivery Fee:')); ?>
                    </div>

                    <div class="form-group">
<?php echo $this->Form->input('opening_time', array('class' => 'form-control col-sm-2', 'label' => 'Opening Time:', 'type' => 'time')); ?>
                    </div>

                    <div class="form-group"> 
<?php echo $this->Form->input('closing_time', array('class' => 'form-control col-sm-2', 'label' => 'Closing Time:', 'type' => 'time')); ?>
                    </div>
                     <div class="form-group">
